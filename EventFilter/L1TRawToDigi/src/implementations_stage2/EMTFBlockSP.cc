...
namespace l1t {
  namespace stage2 {
	...
	// std::cout << "Converted ME1: CSC ID = " << Track_.ME1_CSC_ID() << ", Sector = " << Track_.ME1_sector() 
	// 	  << ", subsector = " << Track_.ME1_subsector() << ", neighbor = " << Track_.ME1_neighbor() << std::endl;
	...
	// std::cout << "Converted ME2: CSC ID = " << Track_.ME2_CSC_ID() << ", Sector = " << Track_.ME2_sector() << ", neighbor = " << Track_.ME2_neighbor() << std::endl;
	...
	// std::cout << "Converted ME3: CSC ID = " << Track_.ME3_CSC_ID() << ", Sector = " << Track_.ME3_sector() << ", neighbor = " << Track_.ME3_neighbor() << std::endl;
	...
	// std::cout << "Converted ME4: CSC ID = " << Track_.ME4_CSC_ID() << ", Sector = " << Track_.ME4_sector() << ", neighbor = " << Track_.ME4_neighbor() << std::endl;
