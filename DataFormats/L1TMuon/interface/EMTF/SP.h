...
namespace l1t {
  namespace emtf {
	...
	/* me1_neighbor(-99), me1_stub_num(-99), me2_neighbor(-99), */
	/* me2_stub_num(-99), me3_CSC_ID(-99), me3_sector(-99), me3_neighbor(-99), me3_stub_num(-99),  */
	/* me4_CSC_ID(-99), me4_sector(-99), me4_neighbor(-99), me4_stub_num(-99),  */
	/* phi_local(-99), phi_local_rad(-99), phi_global(-99),  */
	/* phi_GMT_corr(-99), phi_GMT_rad(-99), phi_GMT_global(-99),   */
